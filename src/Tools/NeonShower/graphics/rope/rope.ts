...
function Rope({
    ...
    return build(ref => {
        return {
            ...
            // constraint_12: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_11")),
            // constraint_13: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_12")),
            // constraint_14: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_13")),
            // constraint_15: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_14")),
            // constraint_16: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_15")),
            // constraint_17: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_16")),
            // constraint_18: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_17")),
            // constraint_19: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_18")),
            // constraint_20: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_19")),
            // constraint_21: get_constraint(ref,compositionGlobal,raytunnelGlobal,quad, ref("constraint_20")),
            outPos: Texture({
                signature: ref("state_sig"),
                historyLength:3,
                drawOps: [{
